...
def test_setup_run_dir():
    ...
    crr_obj.setup_run_directory(mom_input_dir=mom_input_dir, mom_run_dir=mom_run_dir, hgrid=hgrid, vgrid=vgrid, date_range=date_range, tidal_constituents=tidal_constituents)