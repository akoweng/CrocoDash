...
class TestBasicWrapperFunctions:
    ...
    # Defunct
    # def test_setup_bathymetry(self):
    #     self.crr_driver_obj.og_mom6.latitude_extent = [25, 27]
    #     self.crr_driver_obj.og_mom6.longitude_extent = [207, 209]
    #     hgrid = self.crr_driver_obj.grid_gen.create_rectangular_hgrid(self.crr_driver_obj.og_mom6.longitude_extent, self.crr_driver_obj.og_mom6.latitude_extent, self.crr_driver_obj.og_mom6.resolution)
    #     self.crr_driver_obj.wrap_rm6_setup_bathymetry(
    ...
    def test_ocean_forcing(self):
        ...
        hgrid = self.crr_driver_obj.grid_gen.create_rectangular_hgrid(
            self.crr_driver_obj.og_mom6.longitude_extent,
            self.crr_driver_obj.og_mom6.latitude_extent,
            self.crr_driver_obj.og_mom6.resolution,
        )
        vgrid = self.crr_driver_obj.grid_gen.create_vgrid(
            self.crr_driver_obj.og_mom6.number_vertical_layers,
            self.crr_driver_obj.og_mom6.layer_thickness_ratio,
            self.crr_driver_obj.og_mom6.depth,
        )
        # Set up the initial condition
        self.crr_driver_obj.wrap_rm6_setup_initial_condition(
        ...
        self.crr_driver_obj.wrap_rm6_setup_ocean_state_boundaries(
            self.glorys_path,
            ocean_varnames,
    ...
    def test_tides(self, dummy_tidal_data):
        ...
        self.dump_files_dir = Path(self.crr_driver_obj.mom_input_dir / "tides")
        ...
        self.crr_driver_obj.wrap_rm6_setup_tides(
            self.dump_files_dir, "fake_tidal_data.nc", hgrid=hgrid
        )
    ...
    def test_run_directory(self):
        ...
        self.crr_driver_obj.wrap_rm6_setup_run_directory(
            surface_forcing="jra",
