...
class TestBasicWrapperFunctions:
    ...
    def test_ocean_forcing(self):
        ...
        self.glorys_path = os.path.join("/","glade","derecho","scratch","manishrv","inputs_rm6_hawaii","glorys" )
        hgrid = self.crr_driver_obj.grid_gen.create_rectangular_hgrid(self.crr_driver_obj.og_mom6.longitude_extent, self.crr_driver_obj.og_mom6.latitude_extent, self.crr_driver_obj.og_mom6.resolution)
        vgrid = self.crr_driver_obj.grid_gen.create_vgrid(self.crr_driver_obj.og_mom6.number_vertical_layers, self.crr_driver_obj.og_mom6.layer_thickness_ratio, self.crr_driver_obj.og_mom6.depth)
    ...
    def test_tides(self, dummy_tidal_data):
        ...
        self.crr_driver_obj.wrap_rm6_setup_tides(self.dump_files_dir, "fake_tidal_data.nc", hgrid = hgrid)
